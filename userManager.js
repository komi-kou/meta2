    ...
    saveUserSettings(userId, settingsData) {
        try {
            ...
            const userSettings = {
                ...
                target_cv: settingsData.target_cv || '',
                target_cvr: settingsData.target_cvr || '',
                target_budget_rate: settingsData.target_budget_rate || '',
                target_daily_budget: settingsData.target_daily_budget || '',
                target_roas: settingsData.target_roas || '',
